...
cd /usr/bin
# menu
wget -O menu "https://raw.githubusercontent.com/SETANTAZVPN/Ver3/main/menu/menu.sh"
...
wget -O about "https://raw.githubusercontent.com/artanodrop/v4/main/menu/about.sh"
